...
public class ModifiedEmiBannerShieldRecipe extends EmiBannerShieldRecipe {
    public final EmiStack modifiedOutput;
    private final PowerType<?> powerType;
    private final @javax.annotation.Nullable MutableText multiplePowerTypeName;

    public ModifiedEmiBannerShieldRecipe(EmiStack output, Identifier originalRecipeIdentifier, PowerType<?> powerType, @Nullable MutableText multiplePowerTypeName) {

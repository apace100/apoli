...
public class ModifiedEmiBookCloningRecipe extends EmiBookCloningRecipe {
    public final EmiStack modifiedOutput;
    private final PowerType<?> powerType;
    private final @javax.annotation.Nullable MutableText multiplePowerTypeName;

    public ModifiedEmiBookCloningRecipe(EmiStack output, Identifier originalRecipeIdentifier, PowerType<?> powerType, @Nullable MutableText multiplePowerTypeName) {

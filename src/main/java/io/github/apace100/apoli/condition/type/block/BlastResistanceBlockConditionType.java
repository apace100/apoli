...
public class BlastResistanceBlockConditionType extends BlockConditionType {
    ...
    public static final DataObjectFactory<BlastResistanceBlockConditionType> DATA_FACTORY = new SimpleDataObjectFactory<>(
    ...
    public boolean test(World world, BlockPos pos) {
        return comparison.compare(world.getBlockState(pos).getBlock().getBlastResistance(), compareTo);
    }

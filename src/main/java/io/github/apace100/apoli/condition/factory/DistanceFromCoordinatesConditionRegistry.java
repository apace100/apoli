...
//                 // No break on purpose (defaulting to natural spawn)
    ...
    public static void registerBlockCondition(Consumer<ConditionTypeFactory<CachedBlockPosition>> registryFunction){
        for (String alias : getAliases())
            registryFunction.accept(new ConditionTypeFactory<>(Apoli.identifier(alias),

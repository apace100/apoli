...
public interface AllOfMetaConditionType<CX extends ConditionContext, CC extends AbstractCondition<CX, ? extends AbstractConditionType<CX, CC>>> extends MultiMetaConditionType<CX, CC> {
    ...
    static <T extends ConditionContext, C extends AbstractCondition<T, CT>, CT extends AbstractConditionType<T, C>, M extends AbstractConditionType<T, C> & AllOfMetaConditionType<T, C>> ConditionConfiguration<M> createConfiguration(SerializableDataType<C> conditionDataType, Function<List<C>, M> constructor) {

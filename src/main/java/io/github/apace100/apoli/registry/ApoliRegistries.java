...
public class ApoliRegistries {
    ...
    public static final Registry<LoadingConditionFactory> LOADING_CONDITION;
    ...
    static {
        ...
        LOADING_CONDITION = FabricRegistryBuilder.createSimple(LoadingConditionFactory.class, Apoli.identifier("loading_condition")).buildAndRegister();

...
public class RaycastActionType {
    ...
    public static void action(SerializableData.Instance data, Entity entity) {
        ...
        if(hitResult != null && hitResult.getType() != HitResult.Type.MISS) {
            ...
            if(data.isPresent("block_action") && hitResult instanceof BlockHitResult bhr) {
                ActionTypeFactory<Triple<World, BlockPos, Direction>>.Instance blockAction = data.get("block_action");
            ...
            if(data.isPresent("bientity_action") && hitResult instanceof EntityHitResult ehr) {
                ActionTypeFactory<Pair<Entity, Entity>>.Instance bientityAction = data.get("bientity_action");
    ...
    private static double getBlockReach(SerializableData.Instance data, Entity entity) {
        ...
        if (!data.isPresent("block_distance") && !data.isPresent("distance")) {
            return entity instanceof LivingEntity livingEntity && livingEntity.getAttributes().hasAttribute(EntityAttributes.PLAYER_BLOCK_INTERACTION_RANGE)
    ...
    public static ActionTypeFactory<Entity> getFactory() {
        return new ActionTypeFactory<>(Apoli.identifier("raycast"),

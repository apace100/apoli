...
public class ModifyStatusEffectDurationPowerType extends ValueModifyingPowerType {
    ...
    public ModifyStatusEffectDurationPowerType(Power power, LivingEntity entity, RegistryEntry<StatusEffect> statusEffect, List<RegistryEntry<StatusEffect>> statusEffects, Modifier modifier, List<Modifier> modifiers) {
        super(power, entity);

...
public class InteractionPowerType extends PowerType {
    ...
    public InteractionPowerType(Power power, LivingEntity entity, EnumSet<Hand> hands, ActionResult actionResult, Predicate<Pair<World, ItemStack>> itemCondition, Consumer<Pair<World, StackReference>> heldItemAction, ItemStack itemResult, Consumer<Pair<World, StackReference>> resultItemAction) {
        super(power, entity);
        this.hands = hands;
    ...
    protected void performActorItemStuff(InteractionPowerType power, PlayerEntity actor, Hand hand) {

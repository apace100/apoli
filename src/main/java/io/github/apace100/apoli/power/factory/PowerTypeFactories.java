...
public class PowerTypeFactories {

    public static final IdentifierAlias ALIASES = new IdentifierAlias();

    public static final PowerTypeFactory<PowerType> SIMPLE = register(() -> new PowerTypeFactory<>(Apoli.identifier("simple"), new SerializableData(), data -> PowerType::new).allowCondition());
    public static final PowerTypeFactory<PowerType> MULTIPLE = register(() -> new PowerTypeFactory<>(Apoli.identifier("multiple"), new SerializableData(), data -> PowerType::new));
    ...
    public static void register() {
        ...
        register(ModifyDamageTakenPowerType::createFactory);
        ...
        register(ConditionedRestrictArmorPowerType::getConditionedFactory);
        ...
        register(LavaVisionPowerType::createFactory);
        register(ConditionedAttributePowerType::getConditionedFactory);
        ...
        register(ActionOnCallbackPowerType::createFactory);
        ...
        register(OverrideHudTexturePowerType::createFactory);
        ...
        register(ActionOnBlockPlacePowerType::createFactory);
    ...
    public static <T extends PowerType> PowerTypeFactory<T> register(PowerTypeFactory<T> powerTypeFactory) {
        return Registry.register(ApoliRegistries.POWER_FACTORY, powerTypeFactory.getSerializerId(), powerTypeFactory);
    }

    public static <T extends PowerType> PowerTypeFactory<T> register(PowerFactorySupplier<T> factorySupplier) {

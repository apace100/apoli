...
public class SelfActionOnHitPowerType extends CooldownPowerType {
    ...
    public SelfActionOnHitPowerType(Power power, LivingEntity entity, Consumer<Entity> entityAction, Predicate<Entity> targetCondition, Predicate<Pair<DamageSource, Float>> damageCondition, HudRender hudRender, int cooldownDuration) {
    ...
    public static PowerTypeFactory<SelfActionOnHitPowerType> getFactory() {
        return new PowerTypeFactory<>(Apoli.identifier("self_action_on_hit"),

...
public class ParticlePowerType extends PowerType {
    ...
    public ParticlePowerType(Power power, LivingEntity entity, ParticleEffect particleEffect, Predicate<Pair<Entity, Entity>> biEntityCondition, int count, float speed, boolean force, Vec3d spread, double offsetX, double offsetY, double offsetZ, int frequency, boolean visibleInFirstPerson, boolean visibleWhileInvisible) {
        super(power, entity);
